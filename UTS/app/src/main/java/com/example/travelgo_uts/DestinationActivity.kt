package com.example.travelgo_uts
...
class DestinationActivity : AppCompatActivity() {
    ...
    private fun getImageId(nameId: Int): Int {
        return when (nameId) {
            ...
            R.string.destination_name_kalimantung -> R.drawable.pulau_kalimantung
            R.string.destination_name_bajo -> R.drawable.labuan_bajo
            R.string.destination_name_karang -> R.drawable.pulau_karang
            else -> 0 // Fallback
        }
    }
